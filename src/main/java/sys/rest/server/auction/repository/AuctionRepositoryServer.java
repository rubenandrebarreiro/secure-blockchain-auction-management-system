...
public class AuctionRepositoryServer implements AuctionRepositoryAPI {
	...
	@Override
	public Response checkOutcomeAllAuctions(String bidderUserClientID) throws SQLException {
	...
	@Override
	public Response checkOutcomeOpenedAuctions(String bidderUserClientID) throws SQLException {
	...
	@Override
	public Response checkOutcomeClosedAuctions(String bidderUserClientID) throws SQLException {
